...
A2. $$p\mathcal{O}_k$$ is the ideal of $$\mathcal{O}_k$$ generated by $$p$$.

$$\left(\mathcal{O}_{k}/p\mathcal{O}_k\right)^\times$$ is a finite ring: elements of $$\mathcal{O}_{k}$$ modulo all multiples of $$p$$ in $$\mathcal{O}_k$$. To be more specific, any element can be represented as $$a+b\omega$$, where $$a,b\in\Z_p$$ and,
$$
\omega=\begin{cases}

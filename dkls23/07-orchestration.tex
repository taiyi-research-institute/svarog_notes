...
\begin{equation}
  ...
  \mathrm{Com}_{R,i} := \mathrm{Hash}(\mathrm{Enc}(C,i,R_i,\varepsilon_{R,i})).
\end{equation}
\end{patchnote}
...
\begin{equation}
  ...
  d := \mathrm{Hash}\left(
    \mathrm{Enc}\bigl(C,(\mathrm{Com}_{R,j})_{j\in\mathrm{sort}(\mathbb S)}\bigr)
  \right).
\end{equation}
\end{patchnote}

...
沿用 RVOLE 的记号，令 $M_2=\mathrm{Enc}(\tilde a,\eta,\mu)$，再计算
\begin{equation}
\boldsymbol g:=\mathrm{RO}_{\mathbb Z_n^L}
 \bigl(\mathrm{Enc}(\mathrm{sid},\texttt{"gadget-II"},T_{\mathrm{OT}},M_2)\bigr).
\end{equation}
...
\boldsymbol g:=\mathrm{RO}_{\mathbb Z_n^L}
 \bigl(\mathrm{Enc}(\mathrm{sid},\texttt{"gadget-III"})\bigr).
\end{equation}
